...
class GrpcClientTest(unittest.TestCase):
    @mock.patch("src.grpc.clients.grpc_client.client_pb2_grpc")
    @mock.patch("src.grpc.clients.grpc_client.grpc")
    def setUp(self, mocked_grpc, mocked_client_pb2_grpc):
        self.host = "localhost"
        ...
        self.mocked_client_pb2_grpc = mocked_client_pb2_grpc
    ...
    def test_client_login_with_grpc_client(
        ...
        self.mocked_client_pb2_grpc.ClientServiceStub().loginClient.return_value = (
