...
class OrderDetailRepositoryImplTestCase(unittest.TestCase):
    ...
    def test_get_all_order_details_successfully(self):
        order_details_to_insert = order_detail_fixture.build_order_details(count=5)
    ...
    def test_delete_an_order_detail_successfully(self):
        order_details_to_insert = order_detail_fixture.build_order_details(count=3)
    ...
    def test_get_by_order_id(self):
        order_1 = order_detail_fixture.build_order_detail(order_id=1)
