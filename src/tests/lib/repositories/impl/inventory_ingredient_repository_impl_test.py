...
from src.lib.repositories.impl.inventory_ingredient_repository_impl import InventoryIngredientRepositoryImpl
from src.tests.utils.fixtures.inventory_ingredient_fixture import (build_inventory_ingredient,
...
class InventoryIngredientRepositoryImplTestCase(unittest.TestCase):
    ...
    def test_delete_an_inventory_ingredient_successfully(self):
        ...
        self.assertEqual(
            inventory_ingredients, [inventory_ingredients_to_insert[0], inventory_ingredients_to_insert[2]]
        )
    ...
    def test_update_inventory_ingredient_successfully(self):
        ...
        inventory_ingredient_to_update = build_inventory_ingredient(name="updated-name")
        ...
        self.assertEqual(updated_inventory_ingredient.name, inventory_ingredient_to_update.name)
