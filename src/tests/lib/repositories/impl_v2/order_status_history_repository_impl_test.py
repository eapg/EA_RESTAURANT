...
class OrderStatusHistoryRepositoryImplTestCase(SqlAlchemyBaseRepositoryTestCase):
    ...
    def test_get_order_status_history_successfully(self):
        ...
        order_status_history_1 = build_order_status_history(order_status_id=1)
    ...
    def test_set_next_status_history_by_order_id(self, mocked_desc):
        ...
        assert_filter_value_id(self, query_last_order_status_history, value="order_id")
        ...
        mocked_order_by = (
            query_last_order_status_history.return_value.filter.return_value.order_by
        )
        self.assertEqual(
            mocked_order_by.return_value.limit.mock_calls[0].args[0],
            1,
        )
    ...
    def test_get_last_order_status_histories_by_order_ids(
        ...
        order_ids = [1, 2]
        repository = self.order_status_history_repository
        last_order_status_histories = (
            repository.get_last_order_status_histories_by_order_ids(order_ids)
        )
