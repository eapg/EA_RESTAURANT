...
class ProductIngredientRepositoryControllerTestCase(unittest.TestCase):
    ...
    def test_get_product_ingredient_successfully(self):
        ...
        expected_product_ingredient = self.product_ingredient_controller.get_by_id(product_ingredient.id)

        self.product_ingredient_repository.get_by_id.assert_called_with(product_ingredient.id)
