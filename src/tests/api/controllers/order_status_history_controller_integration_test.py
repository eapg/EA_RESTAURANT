...
class OrderStatusHistoryRepositoryControllerIntegrationTestCase(unittest.TestCase):
    def setUp(self):
        self.order_status_history_repository_to_mock = (
            order_status_history_repository_impl.OrderStatusHistoryRepositoryImpl()
        )
        self.order_status_history_repository_to_mock.get_last_status_history_by_order_id = mock.Mock(
            wraps=self.order_status_history_repository_to_mock.get_last_status_history_by_order_id
        )
        self.order_status_history_repository = mock.Mock(
            wraps=self.order_status_history_repository_to_mock
        )
    ...
    def test_get_all_order_status_histories_from_repository_using_controller(self):
        ...
        order_status_histories_to_insert = (
            order_status_history_fixture.build_order_status_histories(count=4)
        )
    ...
    def test_update_order_status_history_from_repository_using_controller(self):
        ...
        order_status_history_to_update = (
            order_status_history_fixture.build_order_status_history(order_id=10)
        )
    ...
    def test_set_next_status_history_by_order_id_from_repository_using_controller(self):
        ...
        self.order_status_history_repository_to_mock.get_last_status_history_by_order_id.assert_called_with(
            order_1.id
        )
