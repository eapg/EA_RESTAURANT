class ProductIngredientController:
    def __init__(self, product_ingredient_repository):
        self._product_ingredient_repository = product_ingredient_repository  # ProductIngredientRepository
    ...
    def delete_by_id(self, product_ingredient_id):
        self._product_ingredient_repository.delete_by_id(product_ingredient_id)
